...
//设置四个边角
@property (nonatomic) PEResizeControl *topLeftCornerView;         //上左角
@property (nonatomic) PEResizeControl *topRightCornerView;        //上右
@property (nonatomic) PEResizeControl *bottomLeftCornerView;      //下左
@property (nonatomic) PEResizeControl *bottomRightCornerView;     //下右

@property (nonatomic) PEResizeControl *topEdgeView;               //上边
@property (nonatomic) PEResizeControl *leftEdgeView;              //左边
@property (nonatomic) PEResizeControl *bottomEdgeView;            //底边
@property (nonatomic) PEResizeControl *rightEdgeView;             //右边

@property (nonatomic) CGRect initialRect;                         //初始矩形
@property (nonatomic) CGFloat fixedAspectRatio;                   //固定长宽比
