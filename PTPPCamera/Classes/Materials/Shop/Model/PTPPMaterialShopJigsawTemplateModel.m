...
@implementation PTPPMaterialShopJigsawTemplateModel

+ (instancetype)shareModel {
    static PTPPMaterialShopJigsawTemplateModel *_model = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _model = [[PTPPMaterialShopJigsawTemplateModel alloc] init];
    });
    return (_model);
}
